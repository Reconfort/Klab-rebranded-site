...
const WhatWeDoCard = () => {
  return (
    <div className="p-6 w-full rounded-3xl flex flex-col justify-start items-center pt-10 text-center border-t border-slate-700 shadow-md shadow-slate-50 scale-95 hover:scale-100 hover:bg-slate-100">
      ...
      <h1 className='mt-8 xl:mt-10 lg:mt-8 md:mt-8 sm:mt-8 text-blue-500 text-lg'>Our Mission</h1>
      <p className='font-light text-sm'>
        Lorem ipsum, dolor sit amet consectetur adipisicing elit. At dicta quia
        corporis iste beatae fugit animi cupiditate ducimus?
      </p>
    </div>
  );
}
